...
urlpatterns = [
    ...
    path('lista_deposito/', views.lista_deposito, name='lista_deposito'),
    path('alta_deposito/',views.alta_deposito,name='alta_deposito'),
    path('eliminacion_deposito/<int:id_deposito>/',views.eliminacion_deposito,name='eliminacion_deposito'),
    path('modificaciones_deposito/<int:id_deposito>/',views.modificaciones_deposito,name='modificaciones_deposito'),
    path('lista_hueco/',views.lista_hueco, name='lista_hueco'),
    path('alta_hueco/',views.alta_hueco, name='alta_hueco'),
