...
def reporte_diario(request):
    ...
    dispensas_lista = []
    for item in dispensas_por_descartable:
    ...
    return render(
        ...
        "reporte_diario.html",
        {
            ...
            "dispensas_por_descartable": dispensas_lista,  # <--- ahora pasa la lista procesada
        },
    )
...
=======
        "descartables": qs,
>>>>>>> 00c1cdb62a076b7f00124b0601fb0cd3f0c4cedf
    })
...
def descartable_mas_dispensados(request):
    ...
    return render(
        request, "descartable_mas_dispensados.html", {"dispensas": dispensas}
    )
...
def modificaciones_descartable(request, id_descartable):
    ...
    niveles = Nivel_Riesgo.objects.all()
    refrigeraciones = Refrigeracion.objects.all()  # mejor nombre plural
