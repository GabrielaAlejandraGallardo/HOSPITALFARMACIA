...
urlpatterns = [
    ...
    path('medicamento/dispensa/<int:id_medicamento>/', views.realizar_dispensa, name='dispensa_medicamento'),
    path('mas-dispensados/', views.medicamentos_mas_dispensados, name='medicamentos_mas_dispensados'),
    path('medicamento/reporte-diario/', views.reporte_diario, name='reporte_diario'),
